                ...
                <div className="w-[800px] h-[110px] flex items-center gap-7  mt-5">
                  <div className="flex flex-1 flex-col  bg-yellow-base rounded-2xl h-[150px] w-full">
                    ...
                    <div className="flex flex-col w-full mb-2">
                      ...
                      <Link to="/allocation" className="text-[14px] flex items-center font-semibold gap-3 text-shades-black ml-[84px] cursor-pointer transition-all duration-300 ease-in-out hover:text-yellow-500 hover:scale-105">
                        Start Now
